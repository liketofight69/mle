...
HEADERS=$(subst .o,.h,$(mle_objects)) 
LIBS=-lncurses

#mle: $(mle_objects)
      #$(CC)    $(mle_cflags) -o main.c $(mle_objects) $(LIBS)



mle: $(mle_objects) ./mlbuf/libmlbuf.a ./termbox/src/libtermbox.a
	$(CC) $(mle_cflags) $(mle_objects) $(mle_static) ./mlbuf/libmlbuf.a ./termbox/src/libtermbox.a $(mle_ldlibs) -o mle $(LIBS)
